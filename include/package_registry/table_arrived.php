...
$q = "SELECT * FROM `Package_List` WHERE `WiD`='$WiD' AND `Status`='Arrived' ORDER BY `Package_Number` ASC LIMIT $start_from, $limit";
...
?>
<div class="row" id="arrived">
			<div class="row">
<div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Packages Arrived (Awaitng Resident Pick-Up)
                        </div>
                        <!-- /.panel-heading -->
...
<?php  
$sql = "SELECT COUNT(`WiD`) FROM Package_List WHERE `WiD`='$WiD' AND Status='Arrived'";  
...
for ($i=1; $i<=$total_pages; $i++) {  
             $pagLink .= "<li class='paginate_button' aria-controls='dataTables-example' tabindex='0'><a href='resident_profile.php?WiD=$WiD#Arrived&page=".$i."'>".$i."</a></li>";  
};  

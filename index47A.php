   ...
   */
    ...
    <div class="modal-content">
      ...
      <div class="panel panel-info">
		...
		<div>
                                    <p>
                                        ...
                                        <span id="loaded_n_total" class="pull-right text-muted"></span>
                                    </p>
                                    <div class="progress progress-striped active">
                                        <div class="progress-bar progress-bar-success" id="progressBar" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100">
                                            <span id="status" class="sr-only">40% Complete (success)</span>
                                        </div>
                                    </div>
                                </div>
      </div>
      <div class="modal-footer">
        ...
        <button type="button" id="sendEmail" name="send_email" onClick="uploadEmail()" class="btn btn-primary" value="emailR">Send Email</button>
      </div>
    </div>
	</form>
  </div>
